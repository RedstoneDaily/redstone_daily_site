...
const positions = ref(['AnimationBlock11', 'AnimationBlock12', 'AnimationBlock21', 'AnimationBlock22', 'AnimationBlock1', 'AnimationBlock2']);
...
<template>
    <div :style="{ backgroundColor: '#f2f2f2', top: 'auto', height: pagesNum >= 1 && pagesNum <= 4 ? '100%' : '0%' }">
        <div class="main">
            ...
            <div>
                ...
                <img :class="(pagesNum == 2) ? 'img21' : 'img20'" src="../../assets/image/knowledge_book.png" alt="">
                <img :class="(pagesNum == 3) ? 'img31' : 'img30'" src="../../assets/image/mojang_banner_pattern.png"
                    alt="">
                <img :class="(pagesNum == 4) ? 'img41' : 'img40'" src="../../assets/image/recovery_compass_07.png"
                    alt="">
            </div>
            <div class="content_box">
                <div class="content_box1" v-if="pagesNum == 1">
                    ...
                    <p :class="{ display: num >= 3 }">我们每日都会排查并分析对你有帮助的红石视频，以便您研究时查看最新进展。</p>
                ...
                <div class="content_box2" v-if="pagesNum == 2">
                    ...
                    <p :class="{ display: num >= 4 }">通过每日的日报数据，长年累月即可形成庞大的数据库供查询。</p>
                </div>
